...
./deploy/dev/offline/build-offline-image.sh          # CPU (Dockerfile)
./deploy/dev/offline/build-offline-image.sh gpu      # GPU (Dockerfile.gpu)
```
...
```bash
./deploy/dev/offline/export-offline-image.sh          # CPU  -> deploy/prod/dist/asr-webservice-preloaded.tar
./deploy/dev/offline/export-offline-image.sh gpu      # GPU  -> deploy/prod/dist/asr-webservice-preloaded-gpu.tar
```
