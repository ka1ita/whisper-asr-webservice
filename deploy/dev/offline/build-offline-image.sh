...
# ./deploy/dev/offline/export-offline-image.sh.
#
...
docker cp "$repo_root/deploy/dev/offline/warmup_models.py" "$container:/app/warmup_models.py"
...
echo "  ./deploy/dev/offline/export-offline-image.sh${arg:+ $arg}"
